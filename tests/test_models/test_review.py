...
class TestReview_1(unittest.TestCase):
    ...
    def test_public_attribute_existence(self):
        # checks for all public attributes in the instannce (Review)
    ...
    def test_default_values(self):
        # checks for the default types of the attribute in (Review)
    ...
    def test_for_to_dict_method(self):
        # checks the types of the diction ary retured by the method (Review)
        ...
        self.assertEqual(object_dict['__class__'], 'Review')
